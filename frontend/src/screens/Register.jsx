            ...
            >
                ...
                <form onSubmit={submitHandler}>
                    ...
                    <div className="mb-4 transform transition-all duration-500 delay-100" style={{ opacity: appear ? 1 : 0, transform: appear ? 'translateY(0)' : 'translateY(20px)' }}>
                        <label className="block text-gray-300 mb-2 font-medium" htmlFor="name">Full Name</label>
                    ...
                    {/* Email Field */}
                    <div className="mb-4 transform transition-all duration-500 delay-200" style={{ opacity: appear ? 1 : 0, transform: appear ? 'translateY(0)' : 'translateY(20px)' }}>
                    ...
                    {/* Password Field */}
                    <div className="mb-6 transform transition-all duration-500 delay-300" style={{ opacity: appear ? 1 : 0, transform: appear ? 'translateY(0)' : 'translateY(20px)' }}>
                    ...
                    {/* Submit Button */}
                    <div className="transform transition-all duration-500 delay-400" style={{ opacity: appear ? 1 : 0, transform: appear ? 'translateY(0)' : 'translateY(20px)' }}>
                        <button
                            type="submit"
                            disabled={loading}
                ...
                <div className="mt-6 border-t border-gray-700 pt-6 text-center transform transition-all duration-500 delay-500" style={{ opacity: appear ? 1 : 0 }}>
                    <p className="text-gray-400">
                        Already have an account? <Link to="/login" className="text-blue-400 hover:text-blue-300 font-medium transition-colors duration-200">Sign in</Link>
                    </p>
                </div>
            </div>
        </div>
